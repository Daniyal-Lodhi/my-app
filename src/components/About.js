...
function About(props) {
  ...
  return (
    <div className='container' >
      <div className="accordion mt-5" id="accordionExample" style={myStyles}  >
        ...
        <div className="accordion-item" style={myStyles} > 
          <h2 className="accordion-header" id="headingThree" style={myStyles} >
          ...
          <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample" style={myStyles} >
            <div className="accordion-body" style={myStyles} >
